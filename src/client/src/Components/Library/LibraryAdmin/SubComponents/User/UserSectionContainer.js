...
// User Part
export const MemberTableMain = styled.div`
	color: ${(props) => props.theme.colors.color};
	background: ${(props) => props.theme.colors.subBackground} !important;
	margin: 20px 1%;
	padding: 20px;
	...
	font-size: 14px;
`;
export const MemberTableTitle = styled.div`
	display: flex;
	flex-wrap: wrap;
...
`;
export const MemberTableRowHead = styled(MemberTableRow)`
	font-size: 20px;
	&:hover{
		color: ${(props) => props.theme.colors.color} !important;
...
`;
export const MemberTableCell = styled.div`
	display: flex;
	flex-wrap: wrap;
	margin: 0;
	padding: .75rem;
	...
	/* overflow-y: hidden; */
`;
export const MemberTableSortSelect = styled.select`
	color: ${(props) => props.theme.colors.color} !important;
	background: ${(props) => props.theme.colors.subBackground} !important;
	padding: 12px 18px;
	border: none;
...
`;
export const MemberTableTitleH2 = styled.h2`
	color: ${(props) => props.theme.colors.color} !important;
	padding: 12px 18px;
	border: none;
	font-size: 24px;
