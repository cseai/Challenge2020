...
import { SubBgAndColor, InbgSelect, InbgInput } from './../LibraryAdminContainer';
// redux
...
const LibraryAdminRightSide = ({ id, getAllBooks, bookLoading, loading, allBooks, sectionNames, activeSection }) => {
	useEffect(() => {
...
export default connect(mapStateToprops, { getAllBooks })(LibraryAdminRightSide);
